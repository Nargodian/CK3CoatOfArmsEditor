...
3. Create a version-numbered zip file: `COAEditor_X.Y.Z.zip`

The version is taken from the latest git tag (e.g., `v1.2.3` → `COAEditor_1.2.3.zip`).
If no tags exist, defaults to `COAEditor_0.0.0.zip`.
