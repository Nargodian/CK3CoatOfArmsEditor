...
if __name__ == '__main__':
    ...
    parser.add_argument('output', type=Path, nargs='?', default='source_coa_files/pattern_atlases', help='Output directory for atlas PNGs (default: source_coa_files/pattern_atlases)')
